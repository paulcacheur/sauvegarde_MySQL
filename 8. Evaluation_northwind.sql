...
/* 1. liste des contacts Français que customers*/


SELECT customers.CompanyName, customers.ContactName, customers.ContactTitle, customers.Phone
FROM Customers
WHERE Customers.Country = 'France';

/* 1. liste des contacts customers et suppliers*/

SELECT customers.CompanyName, customers.ContactName, customers.ContactTitle, customers.Phone,
suppliers.CompanyName, suppliers.ContactName, suppliers.ContactTitle, suppliers.Phone
FROM suppliers
INNER JOIN products
...
/* 2. produits vendus par le fournisseur exotic liquid */
...
SELECT suppliers.CompanyName AS 'nom du fournisseur', COUNT(products.ProductName) AS 'nombre de produits'
FROM products
INNER JOIN suppliers 
on products.SupplierID = suppliers.SupplierID
WHERE Country = 'France'
...
SELECT customers.CompanyName AS 'nom du client', COUNT(orders.OrderID) AS 'comptage du nombre de commandes client'
FROM customers
INNER JOIN orders
...
SELECT customers.CompanyName AS "nom du client",
...
ORDER BY SUM(`order details`.unitPrice * `order details`.Quantity) ASC;
...
SELECT 
	MONTH(orders.OrderDate) AS "mois de 1997",
	SUM(`order details`.UnitPrice*`order details`.Quantity) AS "ventes"
FROM `order details`
INNER JOIN orders
ON `order details`.OrderID = orders.OrderID
WHERE YEAR(orders.OrderDate) = 1997
